...
<div class="col-xl-8 order-xl-1 mx-auto">
	<div class="card">
		...
		<div class="card-body">
			...
			<?php echo form_open('students/change_password/'.$student['student_id'], 'client_register'); ?>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" name="id" class="form-control" placeholder="Student id" readonly value="<?php echo $student['student_id']; ?>">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
