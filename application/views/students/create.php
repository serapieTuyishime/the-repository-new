        ...
        <div class="card">
            <div class="card-header border-0">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo form_open('students/create', 'client_register'); ?>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="School id" value="<?php echo $this->session->userdata('user_id');?>" readonly required>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label class="form-control-label">Years until expiration</label>
										<input type="number" class="form-control" min="1" max="7" value="<?php echo $student['access_years']; ?>" name="access_years">
									</div>
								</div>
							</div>
