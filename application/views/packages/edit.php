<div class="col-xl-8 order-xl-1 mx-auto">
	<div class="card">
		...
		<div class="card-body">
			...
			<?php echo form_open('packages/edit/'.$package['id'], 'client_register'); ?>
                            ...
                            <div class="form-group">
								...
								<div class="row">
									...
									<?php foreach ($package['all_departments'] as $key => $value): ?>
										<div class="col-lg-4">
											<input type="checkbox" name="departments[]" value="<?php echo $value
											['id']; ?>" <?php echo (in_array($value['id'], $package['departments']))? 'checked' :''; ?>>
