	...
	<div class="card">
		<div class="card-header">
			<div class="row align-items-center">
				<div class="col-8">
					<h3 class="mb-0">Schhol account</h3>
				</div>
				<div class="col-4 text-right">
						<a href="<?php echo base_url(); ?>students/index" class="btn btn-sm btn-primary">Ignore</a>
				</div>
			</div>
		</div>
		<div class="card-body">
			...
			<?php echo form_open('schools/change_password', 'client_register'); ?>
